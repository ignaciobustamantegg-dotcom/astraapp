...
const SCREENS: Screen[] = [
  { type: "text", lines: [
    { text: "Você não chegou até aqui para confirmar o que já sabia.", style: "serif-lead" },
    { text: "Chegou para enxergar com mais clareza.", style: "body" },
    { text: "", style: "spacer" },
    { text: "Agora você não vê apenas a conexão.", style: "body" },
    { text: "Vê o padrão.", style: "body" },
    { text: "Vê a ativação.", style: "body" },
    { text: "Vê o desgaste.", style: "body" },
    { text: "Vê o custo.", style: "body" },
    { text: "", style: "spacer" },
    { text: "E isso muda algo dentro de você.", style: "serif-close" },
  ], button: "Continuar" },
  { type: "text", lines: [
    { text: "Antes você reagia sem perceber.", style: "serif-lead" },
    { text: "Agora pode pausar.", style: "body" },
    { text: "", style: "spacer" },
    { text: "Antes confundia intensidade com profundidade.", style: "body" },
    { text: "Agora pode distinguir.", style: "body" },
    { text: "", style: "spacer" },
    { text: "Não se trata de se tornar fria.", style: "highlight-start" },
    { text: "Se trata de se tornar consciente.", style: "highlight-end" },
  ], button: "Continuar" },
  { type: "text", lines: [
    { text: "Você não precisa tomar uma decisão radical hoje.", style: "serif-lead" },
    { text: "Mas pode começar a escolher diferente.", style: "body" },
    { text: "", style: "spacer" },
    { text: "Escolher se ouvir.", style: "body" },
    { text: "Escolher não minimizar sinais.", style: "body" },
    { text: "Escolher não justificar o que te inquieta.", style: "body" },
    { text: "", style: "spacer" },
    { text: "A clareza não te obriga.", style: "body" },
    { text: "Te liberta.", style: "serif-close" },
  ], button: "Continuar" },
  { type: "text", lines: [
    { text: "O objetivo nunca foi analisar outra pessoa.", style: "serif-lead" },
    { text: "Foi entender você mesma.", style: "body" },
    { text: "", style: "spacer" },
    { text: "Pergunte-se com calma:", style: "body" },
    { text: "", style: "spacer" },
    { text: "Se hoje eu me escolho com honestidade…", style: "highlight-start" },
    { text: "o que mudaria na minha forma de me vincular?", style: "highlight-end" },
    { text: "", style: "spacer" },
    { text: "Não responda pelo medo.", style: "body" },
    { text: "Responda pela dignidade.", style: "serif-close" },
  ], button: "Continuar" },
  { type: "journal", title: "Reflexão", prompt: "Que versão de mim quero levar para o meu próximo relacionamento? E o que estou disposta a não aceitar mais?", hint: "(Não é uma promessa. É uma intenção.)", button: "Salvar e continuar" },
  { type: "text", lines: [
    { text: "Este não é o final. É o ponto de partida de uma nova forma de escolher.", style: "serif-lead" },
  ], button: "Finalizar" },
];

const TOTAL_SCREENS = SCREENS.length;

const DayExperience7 = () => {
  ...
  useEffect(() => { const saved = localStorage.getItem(`astra_day7_journal_${user?.id}`); if (saved) setJournalText(saved); }, [user?.id]);
  ...
  if (isLoading) {
    return <DayLoadingScreen dayNumber={7} dayTitle={DAY_TITLES[7]} onComplete={handleLoadingComplete} />;
  }
    ...
    return (
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex flex-col items-center justify-center min-h-[80dvh] px-8">
        ...
        <motion.div initial={{ scale: 0.8, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ delay: 0.2, duration: 0.5 }} className="flex flex-col items-center text-center relative z-10">
          ...
          <h2 className="text-xl text-foreground mb-2" style={{ fontWeight: 200, letterSpacing: "-0.02em", lineHeight: 1.1 }}>Ritual completado</h2>
      ...
      <div className="px-5 pt-3 pb-2 relative z-10 shrink-0">
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="text-center">
            <p className="text-[10px] font-medium tracking-[0.15em] uppercase text-primary/70">Dia 7</p>
            <p className="text-sm text-foreground/70" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 300, letterSpacing: "-0.02em", lineHeight: 1.1 }}>Sua Nova Perspectiva</p>
          </div>
