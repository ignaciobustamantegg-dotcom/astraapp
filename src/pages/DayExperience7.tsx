...
const SCREENS: Screen[] = [
  {
    type: "text",
    lines: [
      { text: "No llegaste hasta aquí para confirmar lo que ya sabías.", style: "serif-lead" },
      { text: "Llegaste para mirarlo con más claridad.", style: "body" },
      { text: "", style: "spacer" },
      { text: "Ahora no solo ves la conexión.", style: "body" },
      { text: "Ves el patrón.", style: "body" },
      { text: "Ves la activación.", style: "body" },
      { text: "Ves el desgaste.", style: "body" },
      { text: "Ves el costo.", style: "body" },
      { text: "", style: "spacer" },
      { text: "Y eso cambia algo dentro de ti.", style: "serif-close" },
    ],
    button: "Continuar",
  },
  {
    type: "text",
    lines: [
      { text: "Antes reaccionabas sin darte cuenta.", style: "serif-lead" },
      { text: "Ahora puedes pausar.", style: "body" },
      { text: "", style: "spacer" },
      { text: "Antes confundías intensidad con profundidad.", style: "body" },
      { text: "Ahora puedes distinguir.", style: "body" },
      { text: "", style: "spacer" },
      { text: "No se trata de volverte fría.", style: "highlight-start" },
      { text: "Se trata de volverte consciente.", style: "highlight-end" },
    ],
    button: "Continuar",
  },
  {
    type: "text",
    lines: [
      { text: "No necesitas tomar una decisión radical hoy.", style: "serif-lead" },
      { text: "Pero sí puedes empezar a elegir distinto.", style: "body" },
      { text: "", style: "spacer" },
      { text: "Elegir escucharte.", style: "body" },
      { text: "Elegir no minimizar señales.", style: "body" },
      { text: "Elegir no justificar lo que te inquieta.", style: "body" },
      { text: "", style: "spacer" },
      { text: "La claridad no te obliga.", style: "body" },
      { text: "Te libera.", style: "serif-close" },
    ],
    button: "Continuar",
  },
  {
    type: "text",
    lines: [
      { text: "El objetivo nunca fue analizar a otra persona.", style: "serif-lead" },
      { text: "Fue entenderte a ti.", style: "body" },
      { text: "", style: "spacer" },
      { text: "Pregúntate con calma:", style: "body" },
      { text: "", style: "spacer" },
      { text: "Si hoy me elijo con honestidad…", style: "highlight-start" },
      { text: "¿qué cambiaría en mi forma de vincularme?", style: "highlight-end" },
      { text: "", style: "spacer" },
      { text: "No respondas desde el miedo.", style: "body" },
      { text: "Respóndete desde la dignidad.", style: "serif-close" },
    ],
    button: "Continuar",
  },
  {
    type: "journal",
    title: "Reflexión",
    prompt: "¿Qué versión de mí quiero llevar a mi próxima relación? ¿Y qué estoy dispuesta a no volver a aceptar?",
    hint: "(No es una promesa. Es una intención.)",
    button: "Guardar y continuar",
  },
  {
    type: "text",
    lines: [
      { text: "Este no es el final. Es el punto de partida de una nueva forma de elegir.", style: "serif-lead" },
    ],
    button: "Finalizar",
  },
];
...
const DayExperience7 = () => {
  ...
  useEffect(() => {
    const saved = localStorage.getItem(`astra_day7_journal_${user?.id}`);
    if (saved) setJournalText(saved);
  }, [user?.id]);

  useEffect(() => {
    if (journalText && user?.id) {
      localStorage.setItem(`astra_day7_journal_${user.id}`, journalText);
    }
  }, [journalText, user?.id]);
