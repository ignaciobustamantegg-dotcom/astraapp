...
const SCREENS: Screen[] = [
  {
    type: "text",
    lines: [
      { text: "Toda elección tiene un costo.", style: "serif-lead" },
      { text: "", style: "spacer" },
      { text: "Incluso cuando decides quedarte.", style: "body" },
      { text: "Incluso cuando decides esperar.", style: "body" },
      { text: "Incluso cuando decides entender una vez más.", style: "body" },
      { text: "", style: "spacer" },
      { text: "No siempre pagas con dinero.", style: "body" },
      { text: "A veces pagas con energía.", style: "body" },
      { text: "Con tranquilidad.", style: "body" },
      { text: "Con claridad.", style: "body" },
      { text: "", style: "spacer" },
      { text: "Y ese costo rara vez es inmediato.", style: "body" },
      { text: "Se acumula.", style: "serif-close" },
    ],
    button: "Continuar",
  },
  {
    type: "text",
    lines: [
      { text: "Cada vez que toleras algo que te incomoda,", style: "serif-lead" },
      { text: "algo dentro de ti se adapta.", style: "body" },
      { text: "", style: "spacer" },
      { text: "Te vuelves más paciente.", style: "body" },
      { text: "Más comprensiva.", style: "body" },
      { text: "Más flexible.", style: "body" },
      { text: "", style: "spacer" },
      { text: "Pero también, a veces,", style: "body" },
      { text: "más silenciosa contigo misma.", style: "body" },
      { text: "", style: "spacer" },
      { text: "Y mientras inviertes en sostener algo incierto,", style: "highlight-start" },
      { text: "postergas algo posible.", style: "highlight-end" },
    ],
    button: "Continuar",
  },
  {
    type: "text",
    lines: [
      { text: "No se trata de juzgar tus decisiones pasadas.", style: "serif-lead" },
      { text: "Se trata de mirar el intercambio.", style: "body" },
      { text: "", style: "spacer" },
      { text: "¿Qué recibías?", style: "body" },
      { text: "¿Qué entregabas?", style: "body" },
      { text: "¿Era equilibrio?", style: "body" },
      { text: "", style: "spacer" },
      { text: "¿O eras tú quien ajustaba siempre primero?", style: "highlight-start" },
      { text: "", style: "highlight-end" },
      { text: "", style: "spacer" },
      { text: "El amor no debería sentirse como una constante compensación.", style: "serif-close" },
    ],
    button: "Continuar",
  },
  {
    type: "text",
    lines: [
      { text: "Hoy no se trata de cortar nada.", style: "serif-lead" },
      { text: "Ni de prometer nada.", style: "body" },
      { text: "Solo de reconocer el costo.", style: "body" },
      { text: "", style: "spacer" },
      { text: "Pregúntate con honestidad:", style: "body" },
      { text: "", style: "spacer" },
      { text: "¿Qué he dejado de lado por sostener esta conexión?", style: "body" },
      { text: "", style: "spacer" },
      { text: "¿He reducido mis estándares?", style: "body" },
      { text: "¿Mi paz?", style: "body" },
      { text: "¿Mi energía?", style: "body" },
      { text: "¿Mi tiempo?", style: "body" },
      { text: "", style: "spacer" },
      { text: "Respóndete sin dramatizar.", style: "body" },
      { text: "Solo con claridad.", style: "serif-close" },
    ],
    button: "Continuar",
  },
  {
    type: "journal",
    title: "Reflexión",
    prompt: "Si continúo exactamente en la misma dinámica durante un año más… ¿qué estaría perdiendo?",
    hint: "(No imagines lo peor. Solo sé honesta contigo.)",
    button: "Guardar y continuar",
  },
  {
    type: "text",
    lines: [
      { text: "Reconocer el costo es el primer paso para dejar de pagarlo.", style: "serif-lead" },
    ],
    button: "Completar Día 6",
  },
];
...
const DayExperience6 = () => {
  ...
  useEffect(() => {
    const saved = localStorage.getItem(`astra_day6_journal_${user?.id}`);
    if (saved) setJournalText(saved);
  }, [user?.id]);

  useEffect(() => {
    if (journalText && user?.id) {
      localStorage.setItem(`astra_day6_journal_${user.id}`, journalText);
    }
  }, [journalText, user?.id]);
