...
const SCREENS: Screen[] = [
  {
    type: "text",
    lines: [
      { text: "No todo lo que te atrae es casual.", style: "serif-lead" },
      { text: "", style: "spacer" },
      { text: "A veces lo que te mueve no es la persona,", style: "body" },
      { text: "sino lo que despierta en ti.", style: "body" },
      { text: "", style: "spacer" },
      { text: "Puede ser intensidad.", style: "body" },
      { text: "Puede ser calma.", style: "body" },
      { text: "Puede ser esa sensación de \"por fin\".", style: "body" },
      { text: "", style: "spacer" },
      { text: "La conexión no siempre empieza en el presente.", style: "body" },
      { text: "A veces empieza en algo que ya conocías.", style: "serif-close" },
    ],
    button: "Continuar",
  },
  {
    type: "text",
    lines: [
      { text: "Detrás de cada elección hay una necesidad.", style: "serif-lead" },
      { text: "", style: "spacer" },
      { text: "Algunas relaciones nos hacen sentir vistos.", style: "body" },
      { text: "Otras nos hacen sentir elegidos.", style: "body" },
      { text: "Otras nos hacen sentir necesarios.", style: "body" },
      { text: "", style: "spacer" },
      { text: "Y cuando una necesidad es profunda,", style: "body" },
      { text: "la confundimos con destino.", style: "body" },
      { text: "", style: "spacer" },
      { text: "Pero no todo lo que se siente fuerte", style: "highlight-start" },
      { text: "es necesariamente sano.", style: "highlight-end" },
    ],
    button: "Continuar",
  },
  {
    type: "text",
    lines: [
      { text: "Cuando alguien activa algo importante en ti,", style: "serif-lead" },
      { text: "tu sistema emocional se enciende.", style: "body" },
      { text: "", style: "spacer" },
      { text: "El cerebro no busca lo mejor.", style: "body" },
      { text: "Busca lo conocido.", style: "body" },
      { text: "Y lo que reduce la ansiedad en el corto plazo.", style: "body" },
      { text: "", style: "spacer" },
      { text: "Por eso ciertas dinámicas se repiten.", style: "body" },
      { text: "No porque quieras sufrir.", style: "body" },
      { text: "Sino porque algo en ti intenta resolver algo pendiente.", style: "serif-close" },
    ],
    button: "Continuar",
  },
  {
    type: "text",
    lines: [
      { text: "Hoy no vamos a analizar a la otra persona.", style: "serif-lead" },
      { text: "Vamos a mirarte a ti.", style: "body" },
      { text: "", style: "spacer" },
      { text: "Pregúntate con calma:", style: "body" },
      { text: "", style: "spacer" },
      { text: "¿Qué sensación busco cuando me conecto con alguien?", style: "highlight-start" },
      { text: "", style: "highlight-end" },
      { text: "", style: "spacer" },
      { text: "¿Ser elegido?", style: "body" },
      { text: "¿Ser validado?", style: "body" },
      { text: "¿Sentirme seguro?", style: "body" },
      { text: "¿Sentirme importante?", style: "body" },
      { text: "", style: "spacer" },
      { text: "No respondas desde la lógica.", style: "body" },
      { text: "Responde desde el cuerpo.", style: "serif-close" },
    ],
    button: "Continuar",
  },
  {
    type: "journal",
    title: "Reflexión",
    prompt: "Cuando me siento atraído por alguien, ¿qué emoción aparece primero en mí?",
    hint: "(No busques la respuesta correcta. Solo observa.)",
    button: "Guardar y continuar",
  },
  {
    type: "text",
    lines: [
      { text: "Reconocer lo que buscas es el primer paso para elegir con claridad.", style: "serif-lead" },
    ],
    button: "Completar Día 2",
  },
];
