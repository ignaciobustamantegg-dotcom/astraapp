...
const SCREENS: Screen[] = [
  {
    type: "text",
    lines: [
      { text: "A veces creemos que estamos eligiendo a alguien.", style: "serif-lead" },
      { text: "", style: "spacer" },
      { text: "Pero también estamos eligiendo un espejo.", style: "body" },
      { text: "", style: "spacer" },
      { text: "La otra persona no solo muestra lo que nos gusta.", style: "body" },
      { text: "También activa lo que aún duele.", style: "body" },
      { text: "", style: "spacer" },
      { text: "Y eso puede sentirse como destino…", style: "highlight-start" },
      { text: "cuando en realidad es reconocimiento.", style: "highlight-end" },
    ],
    button: "Continuar",
  },
  {
    type: "text",
    lines: [
      { text: "Hay detalles que no parecen importantes,", style: "serif-lead" },
      { text: "pero tocan algo profundo.", style: "body" },
      { text: "", style: "spacer" },
      { text: "Un silencio.", style: "body" },
      { text: "Un gesto.", style: "body" },
      { text: "Una distancia mínima.", style: "body" },
      { text: "", style: "spacer" },
      { text: "Y de pronto aparece una versión de ti", style: "body" },
      { text: "que no estabas buscando.", style: "body" },
      { text: "", style: "spacer" },
      { text: "No es exageración.", style: "body" },
      { text: "Es memoria emocional.", style: "serif-close" },
    ],
    button: "Continuar",
  },
  {
    type: "text",
    lines: [
      { text: "A veces la reacción no es por lo que está pasando ahora.", style: "serif-lead" },
      { text: "Es por lo que ya pasó antes.", style: "body" },
      { text: "", style: "spacer" },
      { text: "Tu sistema interno intenta protegerte", style: "body" },
      { text: "usando patrones antiguos.", style: "body" },
      { text: "", style: "spacer" },
      { text: "Por eso, en ciertos vínculos,", style: "body" },
      { text: "no solo se vive la relación…", style: "highlight-start" },
      { text: "Se revive una historia.", style: "highlight-end" },
    ],
    button: "Continuar",
  },
  {
    type: "text",
    lines: [
      { text: "Hoy no se trata de culparte.", style: "serif-lead" },
      { text: "Se trata de entenderte.", style: "body" },
      { text: "", style: "spacer" },
      { text: "Pregúntate con calma:", style: "body" },
      { text: "", style: "spacer" },
      { text: "¿Qué parte de mí se activa cuando me siento inseguro en una relación?", style: "highlight-start" },
      { text: "", style: "highlight-end" },
      { text: "", style: "spacer" },
      { text: "¿La que se esfuerza por agradar?", style: "body" },
      { text: "¿La que se cierra?", style: "body" },
      { text: "¿La que controla?", style: "body" },
      { text: "¿La que se va antes de ser herida?", style: "body" },
      { text: "", style: "spacer" },
      { text: "No respondas como si fueras juez.", style: "body" },
      { text: "Respóndete como si fueras testigo.", style: "serif-close" },
    ],
    button: "Continuar",
  },
  {
    type: "journal",
    title: "Reflexión",
    prompt: "Cuando alguien me importa y siento distancia, ¿qué hago primero?",
    hint: "(Descríbelo con detalles. No busques \"bien o mal\". Solo observa.)",
    button: "Guardar y continuar",
  },
  {
    type: "text",
    lines: [
      { text: "Mirarte sin juzgarte es el primer paso para dejar de repetir.", style: "serif-lead" },
    ],
    button: "Completar Día 3",
  },
];
...
const DayExperience3 = () => {
  ...
  useEffect(() => {
    const saved = localStorage.getItem(`astra_day3_journal_${user?.id}`);
    if (saved) setJournalText(saved);
  }, [user?.id]);

  useEffect(() => {
    if (journalText && user?.id) {
      localStorage.setItem(`astra_day3_journal_${user.id}`, journalText);
    }
  }, [journalText, user?.id]);
