...
const SCREENS: Screen[] = [
  {
    type: "text",
    lines: [
      { text: "No todas las relaciones te quitan energía de inmediato.", style: "serif-lead" },
      { text: "Algunas lo hacen lentamente.", style: "body" },
      { text: "", style: "spacer" },
      { text: "Empiezas con ilusión.", style: "body" },
      { text: "Con esperanza.", style: "body" },
      { text: "Con intensidad.", style: "body" },
      { text: "", style: "spacer" },
      { text: "Pero después de ciertos encuentros,", style: "body" },
      { text: "algo en ti queda más cansado que antes.", style: "body" },
      { text: "", style: "spacer" },
      { text: "No siempre es drama.", style: "body" },
      { text: "A veces es fricción silenciosa.", style: "serif-close" },
    ],
    button: "Continuar",
  },
  {
    type: "text",
    lines: [
      { text: "Tu cuerpo suele saberlo antes que tu mente.", style: "serif-lead" },
      { text: "", style: "spacer" },
      { text: "Tensión en el pecho.", style: "body" },
      { text: "Dificultad para relajarte.", style: "body" },
      { text: "Necesidad constante de confirmar.", style: "body" },
      { text: "", style: "spacer" },
      { text: "Cuando una conexión exige demasiado,", style: "highlight-start" },
      { text: "tu sistema nervioso trabaja horas extras.", style: "highlight-end" },
      { text: "", style: "spacer" },
      { text: "Y eso tiene un costo.", style: "serif-close" },
    ],
    button: "Continuar",
  },
  {
    type: "text",
    lines: [
      { text: "No se trata solo de cuánto sientes.", style: "serif-lead" },
      { text: "Sino de cuánto te desgasta sentirlo.", style: "body" },
      { text: "", style: "spacer" },
      { text: "Hay vínculos que expanden.", style: "body" },
      { text: "Otros que consumen.", style: "body" },
      { text: "", style: "spacer" },
      { text: "Y a veces confundimos intensidad con profundidad.", style: "highlight-start" },
      { text: "Pero la profundidad verdadera no te deja vacío.", style: "highlight-end" },
    ],
    button: "Continuar",
  },
  {
    type: "text",
    lines: [
      { text: "Hoy no vamos a evaluar a la otra persona.", style: "serif-lead" },
      { text: "Vamos a evaluar tu energía.", style: "body" },
      { text: "", style: "spacer" },
      { text: "Pregúntate con calma:", style: "body" },
      { text: "", style: "spacer" },
      { text: "Después de interactuar con esa persona…", style: "body" },
      { text: "", style: "spacer" },
      { text: "¿Me siento más tranquilo o más inquieto?", style: "body" },
      { text: "¿Más claro o más confundido?", style: "body" },
      { text: "¿Más yo… o menos yo?", style: "body" },
      { text: "", style: "spacer" },
      { text: "Escucha tu respuesta sin justificarla.", style: "serif-close" },
    ],
    button: "Continuar",
  },
  {
    type: "journal",
    title: "Reflexión",
    prompt: "Cuando pienso en esta relación, ¿mi energía aumenta o disminuye? ¿En qué momentos lo noto más?",
    hint: "(No busques conclusiones definitivas. Solo registra.)",
    button: "Guardar y continuar",
  },
  {
    type: "text",
    lines: [
      { text: "Registrar tu energía es el primer paso para protegerla.", style: "serif-lead" },
    ],
    button: "Completar Día 4",
  },
];
...
const DayExperience4 = () => {
  ...
  useEffect(() => {
    const saved = localStorage.getItem(`astra_day4_journal_${user?.id}`);
    if (saved) setJournalText(saved);
  }, [user?.id]);

  useEffect(() => {
    if (journalText && user?.id) {
      localStorage.setItem(`astra_day4_journal_${user.id}`, journalText);
    }
  }, [journalText, user?.id]);
