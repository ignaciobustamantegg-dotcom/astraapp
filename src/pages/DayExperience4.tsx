...
const SCREENS: Screen[] = [
  { type: "text", lines: [
    { text: "Nem todos os relacionamentos tiram sua energia de imediato.", style: "serif-lead" },
    { text: "Alguns fazem isso lentamente.", style: "body" },
    { text: "", style: "spacer" },
    { text: "Você começa com ilusão.", style: "body" },
    { text: "Com esperança.", style: "body" },
    { text: "Com intensidade.", style: "body" },
    { text: "", style: "spacer" },
    { text: "Mas depois de certos encontros,", style: "body" },
    { text: "algo em você fica mais cansada do que antes.", style: "body" },
    { text: "", style: "spacer" },
    { text: "Nem sempre é drama.", style: "body" },
    { text: "Às vezes é um atrito silencioso.", style: "serif-close" },
  ], button: "Continuar" },
  { type: "text", lines: [
    { text: "Seu corpo costuma saber antes da sua mente.", style: "serif-lead" },
    { text: "", style: "spacer" },
    { text: "Tensão no peito.", style: "body" },
    { text: "Dificuldade para relaxar.", style: "body" },
    { text: "Necessidade constante de confirmar.", style: "body" },
    { text: "", style: "spacer" },
    { text: "Quando uma conexão exige demais,", style: "highlight-start" },
    { text: "seu sistema nervoso trabalha horas extras.", style: "highlight-end" },
    { text: "", style: "spacer" },
    { text: "E isso tem um custo.", style: "serif-close" },
  ], button: "Continuar" },
  { type: "text", lines: [
    { text: "Não se trata apenas de quanto você sente.", style: "serif-lead" },
    { text: "Mas de quanto te desgasta sentir.", style: "body" },
    { text: "", style: "spacer" },
    { text: "Existem vínculos que expandem.", style: "body" },
    { text: "Outros que consomem.", style: "body" },
    { text: "", style: "spacer" },
    { text: "E às vezes confundimos intensidade com profundidade.", style: "highlight-start" },
    { text: "Mas a profundidade verdadeira não te deixa vazia.", style: "highlight-end" },
  ], button: "Continuar" },
  { type: "text", lines: [
    { text: "Hoje não vamos avaliar a outra pessoa.", style: "serif-lead" },
    { text: "Vamos avaliar sua energia.", style: "body" },
    { text: "", style: "spacer" },
    { text: "Pergunte-se com calma:", style: "body" },
    { text: "", style: "spacer" },
    { text: "Depois de interagir com essa pessoa…", style: "body" },
    { text: "", style: "spacer" },
    { text: "Me sinto mais tranquila ou mais inquieta?", style: "body" },
    { text: "Mais clara ou mais confusa?", style: "body" },
    { text: "Mais eu… ou menos eu?", style: "body" },
    { text: "", style: "spacer" },
    { text: "Ouça sua resposta sem justificá-la.", style: "serif-close" },
  ], button: "Continuar" },
  { type: "journal", title: "Reflexão", prompt: "Quando penso nesse relacionamento, minha energia aumenta ou diminui? Em quais momentos percebo mais?", hint: "(Não busque conclusões definitivas. Apenas registre.)", button: "Salvar e continuar" },
  { type: "text", lines: [
    { text: "Registrar sua energia é o primeiro passo para protegê-la.", style: "serif-lead" },
  ], button: "Completar Dia 4" },
];
...
const DayExperience4 = () => {
  ...
  const handleComplete = async () => { if (!user) return; try { const now = new Date().toISOString(); await supabase.from("audit_progress").update({ day_4_completed_at: now, current_day: 5 }).eq("user_id", user.id); queryClient.invalidateQueries({ queryKey: ["audit_progress", user.id] }); } catch (e) { console.error("Error completing day:", e); } setShowCompletion(true); };
  const screen = SCREENS[currentScreen];

  if (isLoading) {
    return <DayLoadingScreen dayNumber={4} dayTitle={DAY_TITLES[4]} onComplete={handleLoadingComplete} />;
  }
    ...
    return (
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex flex-col items-center justify-center min-h-[80dvh] px-8">
        ...
        <motion.div initial={{ scale: 0.8, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ delay: 0.2, duration: 0.5 }} className="flex flex-col items-center text-center relative z-10">
          ...
          <h2 className="text-xl text-foreground mb-2" style={{ fontWeight: 200, letterSpacing: "-0.02em", lineHeight: 1.1 }}>Dia 4 completado</h2>
      ...
      <div className="px-5 pt-3 pb-2 relative z-10 shrink-0">
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="text-center">
            <p className="text-[10px] font-medium tracking-[0.15em] uppercase text-primary/70">Dia 4</p>
            <p className="text-sm text-foreground/70" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 300, letterSpacing: "-0.02em", lineHeight: 1.1 }}>Revisão de Energia</p>
          </div>
