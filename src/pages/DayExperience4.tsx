...
const SCREENS: Screen[] = [
  {
    ...
    lines: [
      ...
      { text: "algo en ti queda más cansada que antes.", style: "body" },
      { text: "", style: "spacer" },
  ...
  },
  {
    ...
    lines: [
      ...
      { text: "Pero la profundidad verdadera no te deja vacía.", style: "highlight-end" },
    ],
    button: "Continuar",
  },
  {
    ...
    lines: [
      ...
      { text: "", style: "spacer" },
      { text: "¿Me siento más tranquila o más inquieta?", style: "body" },
      { text: "¿Más clara o más confundida?", style: "body" },
