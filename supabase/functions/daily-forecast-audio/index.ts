...
const VOICE_MAP: Record<string, string> = {
  luana: "pFZP5JQG7iQjIQuC4Bku",   // Lily
  selene: "cgSgspJ2msm6clMCkdW9",   // Jessica
  rafael: "TX3LPaxmHKxFdv7VOQHJ",   // Liam
  thiago: "onwK4e9ZLuTAKqWW03F9",   // Daniel
};
...
serve(async (req) => {
  ...
  try {
    ...
    const voiceId = VOICE_MAP[guide.toLowerCase()] || VOICE_MAP.luana;
